...
class ImagePaletteGeneticProblem(GeneticProblem):
    ...
    def __init__(self, image_path, num_colors=5, kMeans=False, mutate_diverse=False, crossover_method='uniform', save_results=True, display=True, use_caching=True):
        """
        ...
        super().__init__(self.results_dir, save_results=save_results, use_caching=use_caching)
    ...
    def run(self, population_size, generations, mutation_rate=0.1, 
        ...
        Returns:
            ...
            fitness_history: History of fitness values over generations
